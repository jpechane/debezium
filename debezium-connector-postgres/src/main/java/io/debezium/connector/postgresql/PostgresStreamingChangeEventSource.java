...
public class PostgresStreamingChangeEventSource implements StreamingChangeEventSource {
        ...
        try {
            ...
            while (context.isRunning()) {
                stream.readPending(message -> {
                    ...
                    offsetContext.updateWalPosition(lsn, lastCompletelyProcessedLsn, message.getCommitTime(), message.getTransactionId(), tableId, taskContext.getSlotXmin());
                    dispatcher
    ...
    public void commitOffset(Map<String, ?> offset) {
        try {
            ...
            final Long lsn = (Long)offset.get(SourceInfo.LAST_COMPLETELY_PROCESSED_LSN_KEY);
