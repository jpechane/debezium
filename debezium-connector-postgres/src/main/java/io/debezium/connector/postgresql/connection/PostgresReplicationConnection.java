    ...
    private ReplicationStream createReplicationStream(final LogSequenceNumber startLsn) throws SQLException, InterruptedException {
        ...
        return new ReplicationStream() {
            ...
            public void read(ReplicationMessageProcessor processor) throws SQLException, InterruptedException {
                ...
                if (messageDecoder.shouldMessageBeSkipped(read, stream.getLastReceiveLSN().asLong(), startLsnLong)) {
                    return;
                }
            ...
            public boolean readPending(ReplicationMessageProcessor processor) throws SQLException, InterruptedException {
                ...
                if (read == null || messageDecoder.shouldMessageBeSkipped(read, stream.getLastReceiveLSN().asLong(), startLsnLong)) {
                    return false;
                }
                deserializeMessages(read, processor);
                return true;
