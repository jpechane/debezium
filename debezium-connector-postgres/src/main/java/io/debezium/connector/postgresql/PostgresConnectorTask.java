...
public class PostgresConnectorTask extends BaseSourceTask {
    ...
    public void start(Configuration config) {
        ...
        final OffsetContext previousOffset = getPreviousOffset(new PostgresOffsetContext.Loader(connectorConfig.getLogicalName(), connectorConfig.databaseName()));
        final Clock clock = Clock.system();

        final SourceInfo sourceInfo = new SourceInfo(connectorConfig.getLogicalName(), connectorConfig.databaseName());
