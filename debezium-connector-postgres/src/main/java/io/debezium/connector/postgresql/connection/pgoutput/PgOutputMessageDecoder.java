...
public class PgOutputMessageDecoder implements MessageDecoder {
    ...
    @Override
    public boolean shouldMessageBeSkipped(ByteBuffer buffer, Long lastReceivedLsn, Long startLsn) {
        LOGGER.trace("==============================================================================");
        LOGGER.trace("Start LSN: {}, Last Received: {}", startLsn, lastReceivedLsn);
        ...
        try {
            ...
            switch(type) {
                ...
                default:
                    ...
                    return MessageDecoder.super.shouldMessageBeSkipped(buffer, lastReceivedLsn, startLsn);
            }
        }
        finally {
