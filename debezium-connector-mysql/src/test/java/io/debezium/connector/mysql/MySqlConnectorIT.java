...
public class MySqlConnectorIT extends AbstractConnectorTest {
    ...
    public void startGTIDSCubes() {
        stopGTIDSCubes();
        cubeController.create(MySQLCube.GTIDS_MASTER.getCubeName());
        cubeController.create(MySQLCube.GTIDS_REPLICA.getCubeName());
        cubeController.start(MySQLCube.GTIDS_MASTER.getCubeName());
        cubeController.start(MySQLCube.GTIDS_REPLICA.getCubeName());
    }

    public void stopGTIDSCubes() {
        cubeController.stop(MySQLCube.GTIDS_MASTER.getCubeName());
        cubeController.stop(MySQLCube.GTIDS_REPLICA.getCubeName());
        cubeController.destroy(MySQLCube.GTIDS_MASTER.getCubeName());
        cubeController.destroy(MySQLCube.GTIDS_REPLICA.getCubeName());
    }
    ...
    public void shouldValidateValidConfigurationWithSSL() {
        Configuration config = MySQLCube.DEFAULT.configuration(docker)
    ...
    public void shouldConsumeAllEventsFromDatabaseUsingSnapshot() throws SQLException, InterruptedException {
        ...
        config = cube.configuration(docker)
                              .with(MySqlConnectorConfig.USER, "snapper")
                              .with(MySqlConnectorConfig.PASSWORD, "snapperpass")
                              .with(MySqlConnectorConfig.SERVER_ID, 18765)
                              .with(MySqlConnectorConfig.SERVER_NAME, "myServer")
        ...
        try (MySQLConnection db = MySQLConnection.forTestDatabase("connector_test", mysqlHost, MySQLCube.MYSQL_PORT);) {
        ...
        try (MySQLConnection db = MySQLConnection.forTestDatabase("emptydb",  mysqlHost, MySQLCube.MYSQL_PORT);) {
            try (JdbcConnection connection = db.connect()) {
